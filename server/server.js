...
app.use(express.static('public'))           // ← Para favicon
app.use('/uploads', express.static('public/uploads')) // ← Para logos
app.use('/api', apiRouter)                  // ← Para API

// Ruta específica para favicon - producción
app.get('/favicon.png', async (req, res) => {
  try {
    ...
    if (fs.existsSync(faviconPath)) {
      ...
      // Si no existe favicon, intentar generarlo del logo actual
